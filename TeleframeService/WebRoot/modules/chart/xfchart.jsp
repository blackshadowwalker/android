			...
			function getdetail(id){
				...
				$.ajax({
					...
					success:function(retext){
						...
						$("#detail").html("地点："+retext.split(",")[0]+"<br/>负责人："+retext.split(",")[1]+"<br/>事件类型："+retext.split(",")[2]+"<br/>时间："+retext.split(",")[3]);
						$("#chart").hide();
						$("#pic").show();
						$("#report").hide();
					}
				...
				$.ajax({
					...
					success:function(retext){
						...
						$('#container').highcharts({
					        ...
					        title: {
					            text: '<span style="font-family:黑体;">安防检测</span>'
					        },
					        tooltip: {
					    	    formatter: function() {
  ...
  <center>
	  <div id="chart">
  	  ...
  	  <div id="report" style="display:none">
	  	  ...
	  	  <table id="table" border=1px cellspacing=0 style="font-size:70%;width:385px;">
	  			<tr>
