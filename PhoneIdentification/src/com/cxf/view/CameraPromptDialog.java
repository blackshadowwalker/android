...
public class CameraPromptDialog extends DialogFragment implements
		OnClickListener {
	...
	public static CameraPromptDialog newInstance(String title, String message,
			FragmentManager fm, Callback cb) {
		CameraPromptDialog frag = new CameraPromptDialog();
		CameraPromptDialog.fm = fm;
		callback = cb;
		Bundle b = new Bundle();
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		if (dialog == null) {
			...
			View view = inflater.inflate(R.layout.dialog_camera_prompt, null,
					false);
