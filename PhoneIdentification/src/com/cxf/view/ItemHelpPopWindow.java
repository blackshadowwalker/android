...
public class ItemHelpPopWindow extends PopupWindow implements OnClickListener {
	private View mMenuView;

	public ItemHelpPopWindow(Context context) {
		super(context);
		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mMenuView = inflater.inflate(R.layout.popwindow_help, null);
		// 尺寸伸缩动画效果 scale
