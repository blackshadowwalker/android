...
public class ServerAdvancedAutoCompleteTextView extends RelativeLayout {

	private Context context;
	private MyAutoCompleteTextView tv;
	String hint = "";

	public ServerAdvancedAutoCompleteTextView(Context context,
			AttributeSet attrs) {
		super(context, attrs);
	...
	public void setAdapter(ServerAutoCompleteAdapter adapter) {
